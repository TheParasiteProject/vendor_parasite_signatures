...
PRODUCT_EXTRA_RECOVERY_KEYS += $(CERTIFICATE_COMMON)/data/releasekey
ifeq ($(TARGET_SUPPORTS_PREBUILT_UPDATABLE_APEX), false)
PRODUCT_MAINLINE_SEPOLICY_DEV_CERTIFICATES=$(CERTIFICATE_COMMON)/data
PRODUCT_MAINLINE_BLUETOOTH_SEPOLICY_DEV_CERTIFICATES=$(CERTIFICATE_COMMON)/data
endif
